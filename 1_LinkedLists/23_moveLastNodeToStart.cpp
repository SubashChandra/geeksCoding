//given a list, move last ndoe to start
//keep tarck of last second nd last node
...
void moveLastToFront(Listnodeptr *start)
{
	...
	//pre has last second node nd cur has the last ndoe
	pre->next=NULL; 
	cur->next=*start; //set next of last node to head
	*start=cur; //set last node as head
}
